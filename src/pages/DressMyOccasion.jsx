...
/* ── OCCASION DATA ── */
const OCCASIONS = [
  { id: 'wedding', image: 'https://images.unsplash.com/photo-1661332517932-2d441bfb2994?w=400&h=300&fit=crop', label: 'Wedding', desc: 'Bridal outfits, engagement looks, and wedding guest glamour', categories: ['bespoke','aso-ebi','ready-to-wear'], tip: 'Sis, start your fittings 6–8 weeks before the big day. Aso-oke or premium lace for the ceremony, then switch to ankara or brocade for the reception. Trust me, you\'ll thank yourself later!' },
  { id: 'owambe', image: 'https://images.unsplash.com/photo-1752343809373-0600ccb3bcd2?w=400&h=300&fit=crop', label: 'Owambe / Party', desc: 'Show up and show out at every celebration with head-turning aso-ebi looks', categories: ['aso-ebi','ankara','ready-to-wear'], tip: 'Owambe is where you bring your full A-game! Bold colours, statement gele, and accessories that say "I came to slay." We can source matching aso-ebi fabric for your whole crew.' },
  { id: 'church', image: 'https://images.unsplash.com/photo-1601210668663-20c0239bd77d?w=400&h=300&fit=crop', label: 'Church / Sunday Best', desc: 'Beautiful, modest styles perfect for worship and fellowship', categories: ['ready-to-wear','ankara','bespoke'], tip: 'Classy cuts with modest necklines always win. I love pairing structured ankara blouses with midi skirts, or a well-tailored shift dress in premium crepe. You\'ll look amazing!' },
  { id: 'corporate', image: 'https://images.unsplash.com/photo-1680878903102-92692799ef36?w=400&h=300&fit=crop', label: 'Corporate / Office', desc: 'Power dressing with African flair for the modern professional', categories: ['ready-to-wear','bespoke'], tip: 'African prints in boardroom-ready cuts — think tailored ankara blazers, pencil skirts, and sharp senator styles. Subtle prints and muted palettes work beautifully for the office.' },
  { id: 'birthday', image: 'https://images.unsplash.com/photo-1656424692994-736ccef90d8e?w=400&h=300&fit=crop', label: 'Birthday Celebration', desc: 'Make your special day even more special with the perfect outfit', categories: ['ready-to-wear','ankara','bespoke'], tip: 'Your birthday outfit should be unapologetically YOU! Bold colours, daring cuts, and personal touches. We can even custom-embroider your name or date into the design.' },
  { id: 'date-night', image: 'https://images.unsplash.com/photo-1753549839764-c7f0b02bd693?w=400&h=300&fit=crop', label: 'Date Night', desc: 'Romantic, chic pieces for an unforgettable evening', categories: ['ready-to-wear','accessories'], tip: 'Less is more for date nights. A well-cut dress in a rich fabric speaks volumes. Pair it with statement earrings and a clutch from our accessories line — you\'ll love it!' },
  { id: 'naming', image: 'https://images.unsplash.com/photo-1752343781467-bf8f7e68d8d2?w=400&h=300&fit=crop', label: 'Naming Ceremony', desc: 'Coordinated family looks for this joyful milestone', categories: ['aso-ebi','ankara','bespoke'], tip: 'Naming ceremonies call for coordinated family outfits. We\'ll source matching fabrics and create complementary designs for everyone — including the little one!' },
  { id: 'graduation', image: 'https://images.unsplash.com/photo-1568805778734-f0a5a77d7272?w=400&h=300&fit=crop', label: 'Graduation', desc: 'Celebrate your achievement in style with a look that commands attention', categories: ['ready-to-wear','ankara'], tip: 'Pick something that photographs beautifully under the gown and stands out for after-ceremony celebrations. A-line dresses and fitted jumpsuits are always a hit!' },
  { id: 'vacation', image: 'https://images.unsplash.com/photo-1760907949955-294e28bf058d?w=400&h=300&fit=crop', label: 'Vacation / Travel', desc: 'Effortless, packable pieces with maximum impact', categories: ['ready-to-wear','ankara','accessories'], tip: 'Go for versatile pieces that dress up or down easily. Ankara resort wear, flowy maxi dresses, and statement accessories that take you from beach to dinner — sorted!' },
  { id: 'everyday', image: 'https://images.unsplash.com/photo-1552162864-987ac51d1177?w=400&h=300&fit=crop', label: 'Everyday Luxury', desc: 'Elevate your daily wardrobe with beautifully made essentials', categories: ['ready-to-wear','ankara'], tip: 'Invest in well-made basics that reflect your style. A perfectly tailored ankara top, quality cotton pieces, and versatile separates that mix and match like a dream.' },
]
