...
export default function Services() {
  const services = [
    { image: 'https://images.unsplash.com/photo-1753549839764-c7f0b02bd693?w=400&h=400&fit=crop', title: 'Custom-Made Outfits', desc: 'This is what we do best. Every custom outfit starts with a real conversation — we learn your style, your body, what you love. Then we design it, pick the fabric together, and sew every detail to your exact measurements.', price: 'From ₦80,000', time: '3–6 weeks' },
    { image: 'https://images.unsplash.com/photo-1568805778734-f0a5a77d7272?w=400&h=400&fit=crop', title: 'Style Advice Session', desc: 'Sit down with Ruth one-on-one. We\'ll go through your wardrobe, figure out what works for you, and create a plan — whether it\'s for a big event, work, or just looking your best every day.', price: 'From ₦25,000', time: '2–3 hours' },
    { image: 'https://images.unsplash.com/photo-1760907949955-294e28bf058d?w=400&h=400&fit=crop', title: 'Ankara & Print Pieces', desc: 'Ready-to-wear ankara and print pieces designed right here in our Lagos studio. Quality fabrics, beautiful designs, and available from XS to 5XL.', price: 'From ₦45,000', time: 'Ready to ship' },
    { image: 'https://images.unsplash.com/photo-1752343809373-0600ccb3bcd2?w=400&h=400&fit=crop', title: 'Owambe & Aso-Ebi', desc: 'From wedding outfits to full Aso-Ebi coordination for your squad — we make sure everyone shows up looking amazing. We handle the fabric, the design, and the sewing for any group size.', price: 'From ₦60,000/person', time: '2–4 weeks' },
    { image: 'https://images.unsplash.com/photo-1756792339453-bc4aa26fc0cd?w=400&h=400&fit=crop', title: 'Accessories', desc: 'The finishing touches that bring everything together. Statement jewellery, custom bags, headpieces, and belts — handpicked to match your outfit perfectly.', price: 'From ₦12,000', time: 'In stock' },
  ]
