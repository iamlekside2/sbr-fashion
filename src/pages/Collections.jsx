      ...
      <div style={{ minHeight: '100vh', background: '#0A0806', paddingTop: 120, paddingBottom: 80 }}>
        <div className="sbr-page-pad" style={{ padding: '0 60px' }}>
          <div style={{ textAlign: 'center', marginBottom: 60 }}>
            <div style={{ fontFamily: 'Cinzel,serif', fontSize: 9, letterSpacing: '0.4em', textTransform: 'uppercase', color: '#C9A84C', marginBottom: 16 }}>Shop the House</div>
            <h1 style={{ fontFamily: 'Cormorant Garamond,serif', fontSize: 'clamp(40px,5vw,64px)', fontWeight: 300, color: '#F9F4EC' }}>
              Our <em style={{ fontStyle: 'italic', color: '#C9A84C' }}>Collections</em>
            </h1>
          </div>
          ...
          {loading ? (
            <div style={{ textAlign: 'center', color: '#8A7A5A', padding: 60 }}>Loading collections...</div>
          ) : filtered.length === 0 ? (
            <div style={{ textAlign: 'center', padding: 80 }}>
              <div style={{ fontFamily: 'Cormorant Garamond,serif', fontSize: 24, fontWeight: 300, color: '#8A7A5A', marginBottom: 16 }}>No pieces in this category yet</div>
              <p style={{ fontSize: 13, color: '#8A7A5A' }}>Check back soon or explore our other collections.</p>
            </div>
          ) : (
