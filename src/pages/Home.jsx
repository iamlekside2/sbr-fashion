...
export default function Home() {
    ...
    supabase
      ...
      .then(({ data }) => {
        if (data && data.length > 0) setTestimonials(data);
          ...
          setTestimonials([
            { id: 1, text: "Ruthchinos understood exactly what I wanted for my traditional wedding. The dress was beyond anything I had imagined.", name: "Adaeze Okonkwo", client_title: "Bride · Lagos", initials: "A" },
            { id: 2, text: "I've been ordering my work outfits from SBR for two years. The quality, the attention to detail — nothing compares.", name: "Folake Adeyemi", client_title: "Corporate Executive · Abuja", initials: "F" },
            { id: 3, text: "The Ankara set she created for my daughter's naming ceremony had everyone asking for her contact. African luxury at its finest.", name: "Chidinma Eze", client_title: "Client · Port Harcourt", initials: "C" },
          ]);
        }
  ...
  const collections = [
    ...
    { emoji: "✨", name: "Custom Couture", cat: "Bespoke", count: "Made to Order", pattern: "radial-gradient(circle at 50% 50%, #C9A84C22 2px, transparent 2px)", bg: "linear-gradient(135deg,#0F0A00,#1F1400)", href: "/collections?cat=bespoke" },
    ...
    { emoji: "👑", name: "Aso-Ebi Luxury", cat: "Occasion Wear", count: "Group Orders Welcome", pattern: "radial-gradient(circle, #C9A84C11 1px, transparent 1px)", bg: "linear-gradient(135deg,#100800,#201000)", href: "/collections?cat=aso-ebi" },
  ];

  const services = [
    { emoji: "✂️", title: "Bespoke Tailoring", desc: "Custom-crafted pieces built to your exact measurements and style preferences. Every stitch tells your story.", href: "/book" },
    { emoji: "🎨", title: "Styling Consultation", desc: "Private one-on-one sessions with our lead stylist to curate your perfect wardrobe and define your aesthetic.", href: "/book" },
    { emoji: "🌺", title: "Ankara & Print Pieces", desc: "A curated ready-to-wear collection of Ankara and African print garments celebrating heritage beautifully.", href: "/collections" },
    { emoji: "💫", title: "Occasion & Aso-Ebi", desc: "From bridal to Owambe, we design complete occasion looks for individuals and groups.", href: "/book" },
  ];

  const interactiveFeatures = [
    { icon: Sparkles, title: "Style Quiz", desc: "Discover your unique SBR style profile and get personalised outfit recommendations.", href: "/style-quiz", accent: "#E8C97A" },
    { icon: Shirt, title: "Dress My Occasion", desc: "Tell us the event and we'll curate the perfect look from our collection.", href: "/dress-my-occasion", accent: "#C9A84C" },
    { icon: Palette, title: "Outfit Builder", desc: "Mix and match pieces to create your dream outfit, then share or add to cart.", href: "/outfit-builder", accent: "#D4AF37" },
    { icon: Scissors, title: "Fabric Swatches", desc: "Browse our premium African fabrics and request samples before you commit.", href: "/fabrics", accent: "#B8960C" },
    { icon: Users, title: "Aso-Ebi Coordinator", desc: "Planning a group outfit for your event? Coordinate colours, fabrics and sizes in one place.", href: "/aso-ebi", accent: "#E8C97A" },
    { icon: Crown, title: "Loyalty Programme", desc: "Earn points with every purchase and unlock exclusive perks, early access, and VIP styling.", href: "/loyalty", accent: "#C9A84C" },
  ]
    ...
    <div>
      ...
      <section className="sbr-hero" style={{ height: "100vh", minHeight: 700, position: "relative", display: "flex", alignItems: "center", overflow: "hidden" }}>
        ...
        <motion.div initial="hidden" animate="show" variants={stagger} className="sbr-hero-content" style={{ position: "relative", zIndex: 2, padding: "0 60px", maxWidth: 700 }}>
          ...
          <motion.h1 variants={fadeUp} style={{ fontFamily: "Cormorant Garamond,serif", fontSize: "clamp(52px,7vw,90px)", fontWeight: 300, lineHeight: 1, color: "#F9F4EC", marginBottom: 24 }}>
            <em style={{ fontStyle: "italic", color: "#C9A84C" }}>Dreams</em> Into Reality
          </motion.h1>
          <motion.p variants={fadeUp} style={{ fontFamily: "Cormorant Garamond,serif", fontSize: 18, fontStyle: "italic", color: "#8A7A5A", marginBottom: 48 }}>
            Where African heritage meets contemporary luxury fashion
          </motion.p>
      ...
      <div style={{ background: "#C9A84C", padding: "14px 0", overflow: "hidden", whiteSpace: "nowrap" }}>
        <div style={{ display: "inline-flex", animation: "marquee 22s linear infinite" }}>
          {["Ready-to-Wear", "Ankara & African Prints", "Bespoke Designs", "Accessories & Jewellery", "Styling Consultations", "Custom Orders",
            "Ready-to-Wear", "Ankara & African Prints", "Bespoke Designs", "Accessories & Jewellery", "Styling Consultations", "Custom Orders"].map((t, i) => (
      ...
      <section id="about" className="sbr-about" style={{ padding: "120px 60px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center" }}>
        <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={stagger}>
          <motion.div variants={fadeUp} style={{ fontFamily: "Cinzel,serif", fontSize: 9, letterSpacing: "0.4em", textTransform: "uppercase", color: "#C9A84C", marginBottom: 16, display: "flex", alignItems: "center", gap: 16 }}>
            <span style={{ width: 30, height: 1, background: "#C9A84C", display: "inline-block" }} />Our Story
          </motion.div>
          <motion.h2 variants={fadeUp} style={{ fontFamily: "Cormorant Garamond,serif", fontSize: "clamp(36px,4vw,56px)", fontWeight: 300, lineHeight: 1.1, color: "#F9F4EC", marginBottom: 20 }}>
            Rooted in Africa.<br />
            <em style={{ fontStyle: "italic", color: "#C9A84C" }}>Dressed for the World.</em>
          </motion.h2>
          ...
          <motion.p variants={fadeUp} style={{ fontSize: 15, lineHeight: 1.9, color: "#8A7A5A", marginBottom: 16 }}>
            Stitches by Ruthchinos is a <strong style={{ color: "#EDE3D0", fontWeight: 400 }}>luxury African fashion house</strong> dedicated to celebrating the richness of African culture through exquisite craftsmanship. Every piece we create tells a story — of heritage, identity, and unapologetic elegance.
          </motion.p>
          <motion.p variants={fadeUp} style={{ fontSize: 15, lineHeight: 1.9, color: "#8A7A5A", marginBottom: 48 }}>
            From hand-selected Ankara fabrics sourced across West Africa to meticulously tailored bespoke pieces, we blend <strong style={{ color: "#EDE3D0", fontWeight: 400 }}>traditional African artistry</strong> with contemporary silhouettes.
          </motion.p>
          <motion.div variants={fadeUp} className="sbr-about-stats" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 32, paddingTop: 48, borderTop: "1px solid rgba(201,168,76,0.2)" }}>
            {[["500+", "Happy Clients"], ["4+", "Years of Excellence"], ["100%", "Bespoke Crafted"]].map(([num, label]) => (
              <div key={label}>
        ...
        <div className="sbr-featured-header" style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 60 }}>
          <div>
            <div style={{ fontFamily: "Cinzel,serif", fontSize: 9, letterSpacing: "0.4em", textTransform: "uppercase", color: "#C9A84C", marginBottom: 8, display: "flex", alignItems: "center", gap: 16 }}>
              ...
              {featured.length > 0 ? "Featured Pieces" : "Shop the House"}
            </div>
            <h2 style={{ fontFamily: "Cormorant Garamond,serif", fontSize: "clamp(36px,4vw,56px)", fontWeight: 300, color: "#F9F4EC" }}>
              {featured.length > 0 ? <>Hand-Picked <em style={{ fontStyle: "italic", color: "#C9A84C" }}>For You</em></> : <>Our <em style={{ fontStyle: "italic", color: "#C9A84C" }}>Collections</em></>}
            </h2>
          </div>
      ...
      <section className="sbr-services-home" style={{ padding: "120px 60px" }}>
        <div style={{ textAlign: "center", marginBottom: 60 }}>
          <div style={{ fontFamily: "Cinzel,serif", fontSize: 9, letterSpacing: "0.4em", textTransform: "uppercase", color: "#C9A84C", marginBottom: 16, justifyContent: "center", display: "flex", alignItems: "center", gap: 16 }}>
            <span style={{ width: 30, height: 1, background: "#C9A84C", display: "inline-block" }} />What We Offer
          </div>
          <h2 style={{ fontFamily: "Cormorant Garamond,serif", fontSize: "clamp(36px,4vw,56px)", fontWeight: 300, color: "#F9F4EC" }}>
        ...
        <div className="sbr-services-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 1, background: "rgba(201,168,76,0.1)" }}>
          {services.map((sv) => (
            <div key={sv.title} style={{ background: "#0A0806", padding: "48px 32px", transition: "background 0.3s" }}
              ...
              <Link to={sv.href} style={{ fontFamily: "Cinzel,serif", fontSize: 8, letterSpacing: "0.2em", textTransform: "uppercase", color: "#C9A84C", textDecoration: "none" }}>Learn More →</Link>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="sbr-process" style={{ padding: "120px 60px", background: "#1C1608", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 80, position: "relative" }}>
          <div style={{ fontFamily: "Cinzel,serif", fontSize: 9, letterSpacing: "0.4em", textTransform: "uppercase", color: "#C9A84C", marginBottom: 16 }}>How It Works</div>
          <h2 style={{ fontFamily: "Cormorant Garamond,serif", fontSize: "clamp(36px,4vw,56px)", fontWeight: 300, color: "#F9F4EC" }}>
            The Bespoke <em style={{ fontStyle: "italic", color: "#C9A84C" }}>Journey</em>
          </h2>
        </div>
        <div className="sbr-process-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", position: "relative" }}>
          ...
          {[["01", "Consultation", "We meet to understand your vision and the story you want your outfit to tell."],
            ["02", "Design & Fabric", "We sketch your design and guide you through premium African fabrics."],
            ["03", "Crafting", "Our master tailors bring your vision to life with meticulous attention to every detail."],
            ["04", "Final Fitting", "A final fitting ensures perfection before the piece becomes part of your wardrobe."]
          ].map(([n, t, d]) => (
      ...
      <section className="sbr-testimonials" style={{ padding: "120px 60px", background: "#111009", textAlign: "center" }}>
        <div style={{ marginBottom: 60 }}>
          <div style={{ fontFamily: "Cinzel,serif", fontSize: 9, letterSpacing: "0.4em", textTransform: "uppercase", color: "#C9A84C", marginBottom: 16 }}>Client Love</div>
          <h2 style={{ fontFamily: "Cormorant Garamond,serif", fontSize: "clamp(36px,4vw,56px)", fontWeight: 300, color: "#F9F4EC" }}>
            What They're <em style={{ fontStyle: "italic", color: "#C9A84C" }}>Saying</em>
          </h2>
        </div>
      ...
      <section className="sbr-interactive" style={{ padding: "120px 60px" }}>
        <div style={{ textAlign: "center", marginBottom: 60 }}>
          ...
          <h2 style={{ fontFamily: "Cormorant Garamond,serif", fontSize: "clamp(36px,4vw,56px)", fontWeight: 300, color: "#F9F4EC" }}>
            Explore & <em style={{ fontStyle: "italic", color: "#C9A84C" }}>Interact</em>
          </h2>
          <p style={{ fontFamily: "Cormorant Garamond,serif", fontSize: 17, fontStyle: "italic", color: "#8A7A5A", marginTop: 12, maxWidth: 500, margin: "12px auto 0" }}>
            Tools designed to make your fashion journey personal and seamless.
          </p>
        </div>
          ...
          <Link to="/spotlight" style={{ textDecoration: "none", display: "flex", alignItems: "center", justifyContent: "space-between", background: "linear-gradient(135deg, rgba(201,168,76,0.08), rgba(201,168,76,0.03))", border: "1px solid rgba(201,168,76,0.15)", padding: "24px 32px", transition: "all 0.3s" }}
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 13, color: "#8A7A5A" }}>See real clients rocking their SBR pieces — get inspired for your next outfit.</div>
              </div>
            </div>
      ...
      <section className="sbr-cta-banner" style={{ padding: "100px 60px", background: "#0A0806", textAlign: "center", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ fontFamily: "Cinzel,serif", fontSize: 9, letterSpacing: "0.4em", textTransform: "uppercase", color: "#C9A84C", marginBottom: 24 }}>Begin Your Journey</div>
        ...
        <p style={{ fontFamily: "Cormorant Garamond,serif", fontStyle: "italic", fontSize: 18, color: "#8A7A5A", marginBottom: 48 }}>
          Book your private consultation with Ruthchinos today.
        </p>
